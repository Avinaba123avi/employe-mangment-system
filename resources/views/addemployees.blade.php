    ...
    <div id="wrapper">
        ...
        @include('layouts.allnavigation')
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-2 text-gray-800">Add Employee Detais</h1>
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Add Employees</h6>
                </div>
                <div class="card-body">
                  <form action="{{ route('addEmplyee') }}" class="user" method="POST">
                    @csrf
                    ...
                    <div class="text-center mb-3">
                      <button type="submit" href="/managercrud" class="btn btn-primary btn-user btn-lg">Add Employee</button>
                    </div> 
                </form>
                </div>
            </div>
