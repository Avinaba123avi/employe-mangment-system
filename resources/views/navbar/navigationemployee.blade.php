<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/employeecrud">View</a>
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item">
        <a class="nav-link" href="/showempsalary">
            <i class="fas fa-rupee-sign text-gray-500"></i>
            <span>Salary</span></a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="/showempattandance">
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item">
        <a class="nav-link" href="/showemptask">
    ...
    <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="/showEmpLeave">Apply Leave</a>
                <a class="collapse-item" href="/showleavedetails">leave History</a>
            </div>
        </div>
    </li>
