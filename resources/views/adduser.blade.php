    ...
    <div id="wrapper">
        ...
        @include('layouts.allnavigation')
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-2 text-gray-800">Add Users Detais</h1>
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Add Users</h6>
                </div>
                <div class="card-body">
                  <form action="{{ route('add.user') }}" class="user" method="POST">
                    ...
                    <div class="text-center mb-3">
                      <button type="submit" href="/admincrud" class="btn btn-primary btn-user btn-lg">Add User</button>
                    </div> 
                </form>
                </div>
            </div>
