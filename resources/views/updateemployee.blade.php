    ...
    <div id="wrapper">
        ...
        @include('layouts.allnavigation')
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-2 text-gray-800">Update Employees Detais</h1>
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Update Employee</h6>
                </div>
                <div class="card-body">
                  <form action="{{ route('update.employeepage',$users->regiuser_id)}}" class="user" method="POST">
                    ...
                    <div class="text-center mb-3">
                      <button type="submit" href="/managercrud" class="btn btn-primary btn-user btn-lg">Update Employee</button>
                    </div> 
                </form>
                </div>
            </div>
